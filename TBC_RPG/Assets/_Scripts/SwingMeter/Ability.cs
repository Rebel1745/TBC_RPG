...
public class Ability : ScriptableObject {
    ...
    public int AOEAreaX; // this effect will be applied to all units within this number of nodes on the X axis
    public int AOEAreaY; // this effect will be applied to all units within this number of nodes on the Y axis
    ...
    public ABILITY_EFFECT AbilityEffect = ABILITY_EFFECT.Damage;
}
